...
public class PlayerChat : NetworkBehaviour
{
    ...
    private void CommandShoot(Vector2 origen, Vector2 direccion)
    {
        ...
        if (hit)
        {
            ...
            {
                bubu.WasHit();
                Debug.Log("le pegué a la burbuja");
            }
        }
    }
    */
    ...
    private void CommandSendMessage(string msj) 
    {
        ...
        ClientSendMessage(msj, bub.GetComponent<cannonBall>());
        
    }
    [ClientRpc]
    private void ClientSendMessage(string msj, cannonBall bub)
    {
        
        //bub.GetComponent<cannonBall>().Initialize(msj);
    }
